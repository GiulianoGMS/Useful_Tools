...
LOOP
  UPDATE MFL_DOCTOFISCAL X SET X.STATUSNFE = 4 WHERE X.SEQNOTAFISCAL = T.SEQNOTAFISCAL AND X.STATUSNFE = 1;
  UPDATE MLF_NOTAFISCAL  X SET X.STATUSNFE = 4 WHERE X.SEQNOTAFISCAL = T.SEQNOTAFISCAL AND X.STATUSNFE = 1;
